        ...
        return (
            <div className="fixed inset-0 bg-background flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center gap-8 px-6 animate-fade-in">
                    {/* Logo Placeholder - Removed src to avoid 404, kept styling */}
                    <div className="w-48 h-16 bg-gradient-to-r from-primary/20 to-accent/20 rounded-lg flex items-center justify-center animate-scale-in">
                        <span className="text-xl font-bold gradient-text">AxionX AI</span>
                    </div>
